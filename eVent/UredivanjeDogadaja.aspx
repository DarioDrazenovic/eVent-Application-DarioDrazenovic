<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/UredivanjeDogadaja.aspx.cs" Inherits="eVent.UredivanjeDogadaja" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Uredivanje dogadaja</title>
    <meta charset="utf-8" />
...
<body>
    <form runat="server">
        ...
        <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s; border-radius: 5px; margin-right: 480px; margin-left: 470px">
            <div class="card-body">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="urediNazivId">
                                        <asp:TextBox ID="txtUrediNaziv" runat="server" Width="250px" CssClass="form-control" meta:resourcekey="txtUrediNazivResource1" />
                                    </div>
                                    <div class="urediNazivId">
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="urediNazivId">
                                        <asp:TextBox ID="txtDatumPocetak" runat="server" Width="250px" placeholder="dd-mm-yyyy" TextMode="DateTime" CssClass="form-control" meta:resourcekey="txtDatumPocetakResource1" />
                                    </div>
                                    <div class="urediNazivId">
                                    ...
                                    <div class="urediNazivId">
                                        <asp:TextBox ID="txtDatumZavrsetak" runat="server" placeholder="dd-mm-yyyy" TextMode="DateTime" CssClass="form-control" meta:resourcekey="txtDatumZavrsetakResource1" />
                                    </div>
                                    <div class="urediNazivId">
                            ...
                            <td>
                                <div>
                                    ...
                                    <div class="urediNazivId">
                                        <asp:FileUpload runat="server" type='file' ID="inputFile" meta:resourcekey="inputFileResource1" />
                                    </div>
                                    <asp:Panel runat="server" ID="panel_slike" meta:resourcekey="panel_slikeResource1"></asp:Panel>
                                </div>
                                <asp:Panel runat="server" ID="gv_slike" meta:resourcekey="gv_slikeResource1"></asp:Panel>
                            </td>
                        </tr>
                    </table>
                    <div class="btnUredivanje" style="text-align: center; font-size: 20px;">
                        <asp:Button runat="server" Text="Odustani" ID="btnOdustani" OnClick="btnOdustani_Click" CssClass="btn btn-secondary" meta:resourcekey="btnOdustaniResource1" />
                        <asp:Button runat="server" Text="Kreiraj" ID="btnUredi" OnClick="btnUredi_Click" CssClass="btn btn-primary" meta:resourcekey="btnUrediResource1" />
                    </div>
                </div>
            </div>
        </div>
